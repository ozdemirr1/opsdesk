...
Published issue: [#18](https://github.com/ozdemirr1/opsdesk/issues/18).
...
## Dependency Target Amendment — 16 September 2026

The guarded PostgreSQL dependency now uses `opsdesk_product_test`, as recorded
in the [B02 target amendment](b02.md#target-amendment--16-september-2026). The
`opsdesk_test` reference in the original snapshot above is historical and must
not be used as the standalone product's test target.
